...
\end{equation*}
\begin{definition}[Thorne, who gave a compact description]
...
\end{remark}
\begin{proposition}[BLGHT, Potential Automorphy 2, Lemma 3.2]
...
\end{equation*}
\begin{theorem}[Sholton, Proposition 3.6]
  \begin{enumerate}[(a)]
...
\section{Chris Skinner's lectures}
...
\section{Jayce Getz's lectures}
\subsection{Langlands $L$-functions and converse theorem}
...
\begin{theorem}[Cogdell--Piatetski-Shapiro; Hecke, Weil]
...
\subsection{Rankin--Selberg products and triple products}
...
\begin{question}[Not an exercise]
...
\subsection{Poisson summation conjecture}

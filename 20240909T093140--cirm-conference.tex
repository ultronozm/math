...
\begin{theorem}[Jacquet--Langlands--Badulescu--???]
...
\begin{example}[Parabolic Eisenstein series]
  \begin{equation*}
  ...
  \end{equation*}
\end{example}
\begin{example}[Hyperbolic Eisenstein series]
...
\begin{theorem}[Mok, Kaletha--Minguez--Shin--White]

...
\end{theorem}
\begin{proof}
  For each fixed $\eps > 0$, we may find $f, f_+ \in C_c^\infty(\mathbb{R}^+)$ such that, writing $1_{A}$ for the character function of a set $A$
  and $F, F_+ $ for the Mellin transforms,

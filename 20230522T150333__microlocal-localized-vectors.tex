...
\begin{remark}
  The Fourier transform $a^\vee$ is a $\tau$-modulated bump (defined by obvious analogy to Definition \ref{definition:d1a910775837} on the dual coin-shaped region
  \begin{equation*}
